	...
	<tbody>
		...
		<tr class="wpls-pro-feature">
			...
			<td>
				...
				<strong><?php echo sprintf( __( 'Utilize this <a href="%s" target="_blank">Premium Features</a> to get best of this plugin.', 'wp-logo-showcase-responsive-slider-slider'), WPLS_PLUGIN_LINK_UNLOCK); ?></strong>
			</td>
		</tr>
