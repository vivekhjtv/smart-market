...
if( !defined( 'WPLS_VERSION' ) ) {
	define( 'WPLS_VERSION', '3.1.2' ); // Version of plugin
}
...
if(!defined( 'WPLS_PLUGIN_LINK_WELCOME' ) ) {
	define('WPLS_PLUGIN_LINK_WELCOME','https://www.essentialplugin.com/wordpress-plugin/wp-logo-showcase-responsive-slider/?utm_source=WP&utm_medium=Logoshowcase&utm_campaign=Welcome-Screen#wpos-epb'); // Plugin Check link
}
