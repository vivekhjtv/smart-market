	...
	<form method="POST" action="https://analytics.wponlinesupport.com">
		<div class="wpos-anylc-optin-wrap">
			...
			<div class="wpos-anylc-optin-cnt">
				...
				<p>Contribute in helping us making <b><?php echo $product_name; ?></b> compatible with most themes and plugins by allowing to share non-sensitive data to <a target="_blank" href="<?php echo WPLS_SITE_LINK; ?>">essentialplugin.com</a> about your website.</p>
