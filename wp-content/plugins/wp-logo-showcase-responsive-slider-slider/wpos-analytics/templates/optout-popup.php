	...
	<div class="wpos-anylc-popup-inr-wrp">
		<div class="wpos-anylc-popup-block">
			...
			<div class="wpos-anylc-popup-body">
				...
				<p>By clicking "Opt Out", we will no longer be sending any data from <b><?php echo $module['name']; ?></b> to <a href="<?php echo WPLS_SITE_LINK; ?>" target="_blank">essentialplugin.com</a>.</p>
			</div>
