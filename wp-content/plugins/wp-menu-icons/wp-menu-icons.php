...
if (!class_exists('QL_Widget')) {
  include_once(WPMI_PLUGIN_DIR . 'includes/quadlayers/widget.php');
}
...
if (!class_exists('WPMI')) {
  ...
  class WPMI
  {
    ...
    function register_icons()
    {
      ...
      foreach ($icons = apply_filters('wp_menu_icons_register_icons', $this->default_icons) as $id => $settings) {
    ...
    function selected_icons($menu_id = null)
    {
      ...
      if (empty($this->registered_icons()->{$selected_icons})) {
        return false;
      }

      return $this->registered_icons()->{$selected_icons};
    }

    function enqueue_style_icons()
    {
      ...
      foreach ($menus_ids as $id => $menu) {
        ...
        if ($selected_icons = $this->selected_icons($menu->term_id)) {
    ...
    function defaults()
    {
      ...
      $register_icons = array(
        ...
        'eleganticons' => array(
          'name' => 'Elegant Icons',
          'url' => plugins_url('icons/eleganticons/style.min.css', WPMI_PLUGIN_FILE),
          'prefix' => '',
        ...
        'elusive' => array(
          'name' => 'Elusive Icons',
          'url' => plugins_url('icons/elusive/css/elusive-icons.min.css', WPMI_PLUGIN_FILE),
        ...
        'fontawesome' => array(
          ...
          'url' => plugins_url('icons/fontawesome/css/font-awesome.min.css', WPMI_PLUGIN_FILE),
        ...
        'foundation' => array(
          ...
          'url' => plugins_url('icons/foundation/foundation-icons.min.css', WPMI_PLUGIN_FILE),
        ...
        'themify' => array(
          'url' => plugins_url('icons/themify/themify-icons.min.css', WPMI_PLUGIN_FILE),
          'name' => 'Themify Icons',
    ...
    function init()
    {
      ...
      add_filter('wp_menu_icons_register_icons', array($this, 'defaults'));
    ...
    {
      set_transient('wpmi-first-rating', true, MONTH_IN_SECONDS / 2);
    }
